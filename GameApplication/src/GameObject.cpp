...
void GameObject::copyVertexData(Vertex * pVertex, int numberOfVertecies)
{
	m_NumberOfVerts = numberOfVertecies;
	glGenBuffers(1, &m_VBO);
	glBindBuffer(GL_ARRAY_BUFFER, m_VBO);
	glBufferData(GL_ARRAY_BUFFER, numberOfVertecies * sizeof(Vertex), pVertex, GL_STATIC_DRAW);
