...
void GameObject::copyVertexData(Vertex *pVerts, int numberOfVertcies, unsigned int * Indcies, int numberOfIndices)
{
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, numberOfIndices * sizeof(unsigned int), Indcies, GL_STATIC_DRAW);
